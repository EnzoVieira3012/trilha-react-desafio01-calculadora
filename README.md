...
Este projeto é uma **calculadora funcional** desenvolvida em **React**, com uma interface moderna e responsiva. Inspirada no design da calculadora do iPhone, ela suporta operações básicas e alternância entre **modo claro** e **modo escuro**.
...
As principais tecnologias utilizadas para construir este projeto são:

- **[React](https://reactjs.org/)**: Biblioteca para construção de interfaces de usuário.
- **[Styled-Components](https://styled-components.com/)**: Estilização com componentes CSS-in-JS.
- **JavaScript (ES6+)**: Para manipulação de lógica e organização do código.
- **Create React App**: Ferramenta para inicializar o projeto.
